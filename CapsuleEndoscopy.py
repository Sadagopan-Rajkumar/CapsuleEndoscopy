...
"")
        ...
        self.label_6.setGeometry(QtCore.QRect(290, 570, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.cscore = QtWidgets.QLabel(self.widget)
        self.cscore.setGeometry(QtCore.QRect(250, 710, 231, 41))
        ...
        self.outcome.setGeometry(QtCore.QRect(250, 610, 231, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(330, 660, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_5 = QtWidgets.QLabel(self.widget)
        self.label_5.setGeometry(QtCore.QRect(640, 570, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.about = QtWidgets.QLabel(self.widget)
        self.about.setGeometry(QtCore.QRect(550, 610, 341, 141))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "INTESTINAL ABNORMALITIES DETECTION \n"
"           AND QUANTIFICATION SYSTEM              "))
        self.label_6.setText(_translate("Dialog", "Predicted pathology"))
        self.upload.setText(_translate("Dialog", "UPLOAD CAPSULE \n"
" ENDOSCOPY IMAGE"))
...
" PATHOLOGY"))
        ...
        self.label_8.setText(_translate("Dialog", "Input capsule endoscopy image"))
        ...
        self.ab=None
        self.out=None
        self.model=tf.keras.models.load_model("capsule endoscopy.h5")
    ...
    def predictimage(self):
            class_names = ['Normal', 'Ulcer', 'Polyp', 'Esophagatis']
            img = self.image
            ...
            out=round(np.amax(self.predictions) * 100, 2)
            if out<0.9 and pred_labels!=0:
                a="Low"
            elif out>0.91 and out<0.95 and pred_labels!=0:
                a="Moderate"
            elif out>0.96 and pred_labels!=0:
                a="High"
            if pred_labels==0:
                out="the given endoscopy image of the patient appears to be \n normal and devoid of any abnormalities"
                a="Normal"
            elif pred_labels==1:
                out="Ulcer is an inflammatory bowel disease (IBD) that \n causes inflammation and ulcers (sores) \n in your digestive tract. Ulcerative colitis \n affects the innermost lining \n of your colon, and rectum."
            elif pred_labels==2:
                out="A colon polyp is a \n small clump of cells that forms \n on the lining of the colon. \n Most colon polyps are harmless. \n But over time, some colon polyps can \n develop into colon cancer, which may be fatal when found in its later stages."
            else:
                out="Esophagitis is inflammation \n of the esophagus. Esophagitis can \n cause painful, difficult swallowing \n and chest pain."
            self.outcome.setText("Model predict: {} ".format(class_names[int(pred_labels)]))
            self.cscore.setText("{}".format(a))
            self.about.setText("{}".format(out))
